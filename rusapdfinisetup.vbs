...
If choiceEncrypt = 6 Then
    ...
    Else
        choicePassLength = 8
    End If
    choiceSavePassToTxt = MsgBox("Записывать пароль в файл?" & vbCrLf & "(будет перезаписан при каждом запуске aadfPDF.vbs)", 4, "pdfSavePassToTxt")
...
objIniFile.Close
MsgBox "Изменения в ini файл были успешно внесены!", 0, "apdfPDF.ini"
WScript.Quit
